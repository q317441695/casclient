...
public abstract class AbstractTicketValidationFilter extends AbstractCasFilter {
	...
	private final String TARGETTICKET = "targetTicket";
    ...
    public final void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse,
        ...
        if (CommonUtils.isNotBlank(ticket)) {
            ...
            try {
                ...
                String targetTickit = request.getParameter(TARGETTICKET);
                Cookie cookie = new Cookie("CASTGC",targetTickit);
                ...
                if (this.redirectAfterValidation) {
                    ...
                    if(url.indexOf("&" + TARGETTICKET)>-1){
                    	url = url.replaceAll("&" + TARGETTICKET + "=" + targetTickit, "");
                    }else{
                    	url = url.replaceAll("\\?" + TARGETTICKET + "=" + targetTickit, "");
                    }
